...
public class Exercicio1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * } catch (IOException e) {: Captura uma excecao do tipo IOException 
		 * caso ocorra um erro durante a escrita do arquivo. 
		 * 
		 * 
		 * System.out.println("Erro ao salvar o texto no arquivo: " +
		 * e.getMessage());: Exibe uma mensagem de erro indicando o problema ocorrido
		 * durante a escrita do arquivo. A mensagem de erro é obtida a partir da excecao
		 * IOException.
		 */
